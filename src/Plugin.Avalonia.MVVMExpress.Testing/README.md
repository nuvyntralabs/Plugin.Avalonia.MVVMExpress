...
Target framework: `net10.0`. Depends on [Core](https://www.nuget.org/packages/Plugin.Avalonia.MVVMExpress.Core). Reference from test projects only. Version `1.0.1`.
