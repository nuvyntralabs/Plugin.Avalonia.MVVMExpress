...
{
    public const string PackageId = "Plugin.Avalonia.MVVMExpress.Templates";
    public const string PackageVersion = "1.0.1";
    public const string AppShortName = "avalonia-mvvmexpress";
    public const string PageShortName = "avalonia-mvvmexpress-page";
    ...
    public static async Task CreateAppAsync(string name, string outputDir, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("Could not create the Avalonia MVVMExpress app." + Environment.NewLine + result.Combined);
        }
    }
    ...
    public static async Task AddPageAsync(string name, string namespaceName, string outputDir, CancellationToken cancellationToken)
    {
        ...
        if (result.ExitCode != 0)
        {
            throw new InvalidOperationException("Could not add the Avalonia MVVMExpress page." + Environment.NewLine + result.Combined);
        }
    }
