...
export function activate(context: vscode.ExtensionContext): void {
  context.subscriptions.push(
    vscode.commands.registerCommand("avaloniamvvmexpress.createApp", () => runCreateApp()),
    vscode.commands.registerCommand("avaloniamvvmexpress.addPage", () => runAddPage()),
  );
}
...
async function runCreateApp(): Promise<void> {
  try {
    ...
    const folder = await vscode.window.showOpenDialog({
      ...
      title: "Avalonia MVVMExpress app folder",
    });
...
async function runAddPage(): Promise<void> {
  try {
    ...
    const folder = await vscode.window.showOpenDialog({
      ...
      title: "Avalonia MVVMExpress page folder",
    });
