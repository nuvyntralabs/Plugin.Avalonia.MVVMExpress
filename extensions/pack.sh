...
"$root/vscode/pack.sh" "$dist/nuvyntralabs.avalonia-mvvmexpress-${version}.vsix"

echo "Packing Visual Studio VSIX $version"
"$root/visualstudio/pack-vsix.sh" "$dist/nuvyntralabs.AvaloniaMVVMExpress.VisualStudio.${version}.vsix"
