...
namespace Plugin.Avalonia.MVVMExpress.Core.Tests.Auth;
...
public sealed class AuthChallengeTests
{
    ...
    private sealed class ChallengeAuth : IAuthState
    {
        ...
        public Task<Plugin.Avalonia.MVVMExpress.Outcome.Outcome> SignInAsync(string userName, string password, CancellationToken cancellationToken = default)
        {
            IsAuthenticated = true;
            Changed?.Invoke(this, EventArgs.Empty);
            return Task.FromResult(Plugin.Avalonia.MVVMExpress.Outcome.Outcome.Success());
        }
