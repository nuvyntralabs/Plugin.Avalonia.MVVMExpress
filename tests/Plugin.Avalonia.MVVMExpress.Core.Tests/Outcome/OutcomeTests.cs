...
namespace Plugin.Avalonia.MVVMExpress.Core.Tests.Outcome;
...
public sealed class OutcomeTests
{
    ...
    {
        var result = Plugin.Avalonia.MVVMExpress.Outcome.Outcome.Success();
    ...
    {
        var result = Plugin.Avalonia.MVVMExpress.Outcome.Outcome.Failure("E_NET", "offline");
    ...
    public void Failure_NullError_Throws()
        => Assert.Throws<ArgumentNullException>(() =>
            Plugin.Avalonia.MVVMExpress.Outcome.Outcome.Failure((ErrorInfo)null!));
