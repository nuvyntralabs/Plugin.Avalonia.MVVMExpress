...
namespace Plugin.Avalonia.MVVMExpress.Core.Tests.Forms;
...
public sealed class FormFieldAndSubmitTests
{
    ...
    private sealed class ConfirmForm : FormViewModel
    {
        ...
        public Task<Plugin.Avalonia.MVVMExpress.Outcome.Outcome> RunSubmitAsync()
            => SubmitAsync(_ => Task.FromResult(Plugin.Avalonia.MVVMExpress.Outcome.Outcome.Success()));
