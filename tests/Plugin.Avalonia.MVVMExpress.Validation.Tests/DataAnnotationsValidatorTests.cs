...
using Plugin.Avalonia.MVVMExpress.Validation;

namespace Plugin.Avalonia.MVVMExpress.Validation.Tests;
...
public sealed class DataAnnotationsValidatorTests
{
    ...
    {
        Assert.Equal("Plugin.Avalonia.MVVMExpress.Validation", ValidationMarker.PackageId);
    }
